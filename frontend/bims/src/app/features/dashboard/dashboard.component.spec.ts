...
describe('DashboardComponent', () => {
    ...
    let uwServiceSpy: jasmine.SpyObj<UnderwritingService>;
    ...
    beforeEach(async () => {
        ...
        uwServiceSpy = jasmine.createSpyObj('UnderwritingService', ['getAssigned']);
        ...
        await TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: UnderwritingService, useValue: uwServiceSpy }
            ]
        }).compileComponents();
