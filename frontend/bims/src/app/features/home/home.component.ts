...
@Component({
  ...
  styles: [`
    ...
    .nav {
      ...
      border-bottom: 1px solid rgba(196,100,120,0.1);
    ...
    .hero-bg {
      ...
      background-attachment: scroll; /* Simplified scrolling behavior as requested */
    }
    /* Rich dark overlay – refined to ensure the image details are visible but text remains readable */
    .hero-overlay {
      position: absolute; inset: 0;
      background: linear-gradient(
        to bottom,
        rgba(26, 18, 14, 0.75) 0%,
        rgba(26, 18, 14, 0.5) 50%,
        rgba(26, 18, 14, 0.85) 100%
      );
      z-index: 1;
    }
    ...
    .hero h1 {
      ...
      color: #FAF6F0; margin-bottom: 28px;
    }
    .hero h1 em { font-style: normal; color: #E0A0AE; font-family: 'Space Grotesk', sans-serif; text-decoration: underline; text-underline-offset: 8px; text-decoration-color: rgba(224,160,174,0.4); }
    .hero-sub {
      font-size: 1.25rem; color: rgba(245,240,232,0.8);
      line-height: 1.8; max-width: 620px; margin: 0 auto 52px;
      font-weight: 400;
    }
    ...
    .btn-hero-primary {
      ...
      color: #FAF6F0; padding: 18px 44px; border-radius: 14px;
      font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; font-weight: 800;
      text-decoration: none; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
      display: inline-flex; align-items: center; gap: 10px;
      box-shadow: 0 10px 40px rgba(92,18,39,0.5);
    }
    .btn-hero-primary:hover { transform: translateY(-3px) scale(1.02); box-shadow: 0 15px 45px rgba(92,18,39,0.7); }
    .btn-hero-outline {
      background: rgba(255,255,255,0.06); color: #FAF6F0;
    ...
    .btn-hero-outline:hover { border-color: rgba(245,240,232,0.8); background: rgba(255,255,255,0.1); transform: translateY(-3px); }
    ...
    .footer-logo-img { height: 56px; width: auto; object-fit: contain; display: block; margin-bottom: 14px; }
    ...
    /* ── AI SECTION ─────────────────────────────────── */
    .ai-section { background: #1A120E; color: #FAF6F0; position: relative; overflow: hidden; }
    .ai-grid { display: grid; grid-template-columns: 0.8fr 1.2fr; gap: 60px; align-items: center; max-width: 1200px; margin: 0 auto; }
    ...
    .ai-glow {
      ...
      background: radial-gradient(circle, rgba(152,35,64,0.3) 0%, transparent 70%);
      filter: blur(40px); animation: pulse-glow 4s infinite alternate;
    }
    .ai-orb {
      width: 140px; height: 140px; border-radius: 50%;
      background: linear-gradient(135deg, #982340, #5C1227);
      display: flex; align-items: center; justify-content: center;
      box-shadow: 0 0 50px rgba(152,35,64,0.4);
      z-index: 2; position: relative;
    }
    .ai-badge {
      position: absolute; bottom: 60px;
      background: rgba(255,255,255,0.08); backdrop-filter: blur(10px);
      padding: 8px 20px; border-radius: 999px; border: 1px solid rgba(255,255,255,0.15);
      font-size: 0.75rem; font-weight: 700; color: #E0A0AE; letter-spacing: 1px;
    }
    ...
    .ai-section .section-title { color: #FAF6F0; }
    .ai-section .section-sub { color: rgba(245,240,232,0.6); }

    .ai-features-list { margin-top: 40px; display: flex; flex-direction: column; gap: 28px; }
    .ai-feature-item { display: flex; gap: 20px; }
    .ai-icon {
      width: 44px; height: 44px; border-radius: 12px; background: rgba(152,35,64,0.2);
      display: flex; align-items: center; justify-content: center; flex-shrink: 0;
    }
    .ai-icon span { color: #E0A0AE; font-size: 1.4rem; }
    .ai-feature-item h4 { font-family: 'Space Grotesk', sans-serif; font-size: 1.05rem; color: #FAF6F0; margin-bottom: 4px; font-weight: 700; }
    .ai-feature-item p { font-size: 0.88rem; color: rgba(245,240,232,0.5); line-height: 1.6; }
    ...
    @media (max-width: 960px) {
      ...
      .how-grid, .ai-grid { grid-template-columns: 1fr; gap: 40px; }
      .ai-visual-wrap { height: 300px; order: 2; }
